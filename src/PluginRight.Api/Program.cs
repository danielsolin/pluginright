...
static class OutputNormalizer
{
    ...
    )
    {
        ...
        header.AppendLine($"// Purpose: {Shorten(userPrompt, 100)}");
        header.AppendLine("// Message: <unknown>");
        header.AppendLine("// Stage: <unknown>");
        header.AppendLine("// Entity: <unknown>");
        header.AppendLine("// Filtering Attributes: none");
        header.AppendLine("// Pre-Images: none");
        header.AppendLine("// Post-Images: none");
        header.AppendLine("// Assumptions: generated by PluginRight");

        // Prepend header before first using/namespace
